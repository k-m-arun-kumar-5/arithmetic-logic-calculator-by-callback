Description :
=============
 demonstrate of callback function pointer for arithmetic operation (in addition, subtraction, multiplication, division and modulus) and logic operation (in AND, OR, XOR, Complement).  
